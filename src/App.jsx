...
import { FaUniversity, FaMoneyBillWave, FaPassport, FaHome, FaHeadset, FaGlobe, FaEnvelope, FaPhone, FaMapMarker } from 'react-icons/fa';
  ...
  const content = {
    uz: {
      ...
      benefits: {
        ...
        items: [
          { icon: <FaUniversity />, title: "Top universitetlar", text: "Oxford, Cambridge, UCL va boshqa nufuzli OTMlar" },
          { icon: <FaMoneyBillWave />, title: "Moliyaviy yordam", text: "Grantlar, stipendiyalar va kreditlar bo'yicha maslahat" },
          { icon: <FaPassport />, title: "Visa yordami", text: "Visa olish jarayonida professional yordam" },
          { icon: <FaHome />, title: "Turar joy", text: "Talabalar uchun xavfsiz va qulay yashash joylari" },
          { icon: <FaHeadset />, title: "Qo'llab-quvvatlash", text: "24/7 yordam va maslahat xizmati" },
          { icon: <FaGlobe />, title: "Madaniy integratsiya", text: "Britaniya madaniyatiga tez moslashish" }
        ]
      ...
      footer: {
        ...
        about: "Biz talabalarni Buyuk Britaniya universitetlariga o'qishga yuborish bo'yicha professional xizmat ko'rsatamiz.",
        contact: "Kontaktlar",
    ...
    ru: {
      ...
      benefits: {
        title: "Преимущества",
        items: [
          { icon: <FaUniversity />, title: "Топ университеты", text: "Oxford, Cambridge, UCL и другие" },
          { icon: <FaMoneyBillWave />, title: "Финансовая помощь", text: "Консультации по грантам и стипендиям" },
          { icon: <FaPassport />, title: "Визовая поддержка", text: "Помощь при получении студенческой визы" },
          { icon: <FaHome />, title: "Проживание", text: "Помощь в поиске жилья" },
          { icon: <FaHeadset />, title: "Поддержка", text: "Круглосуточная консультация" },
          { icon: <FaGlobe />, title: "Интеграция", text: "Помощь в адаптации к культуре" }
        ]
      },
      ...
      footer: {
        ...
        about: "Мы предоставляем услуги по поступлению в университеты Великобритании.",
        contact: "Контакты",
    ...
    en: {
      ...
      benefits: {
        title: "Benefits",
        items: [
          { icon: <FaUniversity />, title: "Top Universities", text: "Oxford, Cambridge, UCL and more" },
          { icon: <FaMoneyBillWave />, title: "Financial Aid", text: "Guidance on scholarships and grants" },
          { icon: <FaPassport />, title: "Visa Assistance", text: "Support during visa process" },
          { icon: <FaHome />, title: "Accommodation", text: "Safe housing for students" },
          { icon: <FaHeadset />, title: "Support", text: "24/7 student support service" },
          { icon: <FaGlobe />, title: "Cultural Integration", text: "Help adapting to UK culture" }
        ]
      },
      ...
      footer: {
        ...
        about: "We provide consulting services for students who want to study in the UK.",
        contact: "Contacts",
  ...
  return (
    <>
      ...
      <div className="App">
          ...
          <div className="container">
            <div className="about-content">
              <div className="about-text">
                ...
                <h2>
                  {currentContent.aboutSlider.titles[currentIndex]}
                </h2>
                ...
                {currentIndex === 0 ? (
                  <p>
                    ...
                    {currentContent.aboutSlider.texts[0]}
                  </p>
                ) : currentIndex === 1 ? (
                  <p>
                    {currentContent.aboutSlider.texts[1]}
                  </p>
                ) : (
                  <p>
                    {currentContent.aboutSlider.texts[2]}
                  </p>
                )}

                <button className="cta-button">{currentContent.header.cta}</button>
              </div>
          ...
          <div className="container">
            ...
            <div className="biz2">
              <div className="sertificate">
                <button onClick={() => setIsSertifikatOpen(true)}> {currentContent.team.button}  &#10095;  </button>
              </div>
            </div>
          </div>
        </section>
        ...
        {isSertifikatOpen && (
          <div className="sertifikat-overlay" onClick={() => setIsSertifikatOpen(false)}>
            <div className="sertifikat-box" onClick={(e) => e.stopPropagation()}>
        ...
        {isModalOpen && (
          <div className="modal-overlay" onClick={() => setIsModalOpen(false)}>
            <div className="modal-box" onClick={(e) => e.stopPropagation()}>
              ...
              <button className="cta-button">{currentContent.modal.send}</button>
